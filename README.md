...
Отредактируйте константу в `openai_integration.py`:

```python
ANALYSIS_PROMPT = """
Ваш кастомный промпт для анализа...
...
**Ошибка `total_tokens` в веб-интерфейсе:**
```
Обновите код - эта ошибка исправлена в последней версии
```
