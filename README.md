...
**Текущая версия:** 0.5 _(этап перехода на 0.6 в разработке)_
...
- **🔐 Санитайзинг секретов** — автоматическое маскирование конфиденциальных данных перед отправкой в LLM
...
_Дополнительные языки можно подключить, реализовав новые парсеры по шаблону из папки parsers/._
...
- **Размерность эмбеддингов**: 1024d (единый стандарт для всех компонентов)
...
├───────────────────────┼────────┼───────────────────────────────────────────────┤
│ Qdrant Vector Store   │  ✅ ok │ Хост: localhost, Коллекция: repo_sum, Размерность: 1024 │
└───────────────────────┴────────┴───────────────────────────────────────────────┘

Общий статус системы: HEALTHY
```
