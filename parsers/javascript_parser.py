"""
Парсер для JavaScript файлов (.js, .jsx).
"""
...
class JavaScriptParser(BaseParser):
    """
    Парсер для JavaScript файлов. Извлекает классы, функции, импорты и комментарии.
    """
    def __init__(self):
        super().__init__()
        # Поддерживаемые расширения для JavaScript
        self.supported_extensions = ['.js', '.jsx']
        # Регулярные выражения для комментариев в JavaScript
    ...
    def parse_file(self, file_info: FileInfo) -> ParsedFile:
        """
        Основной метод парсинга JavaScript файла.
        """
    ...
    def extract_imports(self, source_code: str) -> List[str]:
        """
        Извлекает import-выражения из JavaScript кода.
        """
        imports = []
    ...
    def extract_classes(self, source_code: str) -> List[ParsedElement]:
        """
        Извлекает классы из JavaScript кода.
        """
        classes = []
    ...
    def extract_functions(self, source_code: str) -> List[ParsedElement]:
        """
        Извлекает функции и методы из JavaScript кода.
        """
        functions = []
