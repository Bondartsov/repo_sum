# Единые Инструкции для Агентов (AGENTS.md)

Этот документ содержит единые инструкции для всех агентов, работающих с проектом repo_sum. Документ является обязательным руководством для всех участников разработки.
