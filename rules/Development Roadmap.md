...
⚠️ Примечание: Matryoshka-сжатие (1024→384) заявлено в архитектуре, но по умолчанию пока не включено. Требуется его активация и проверка влияния на качество поиска.
