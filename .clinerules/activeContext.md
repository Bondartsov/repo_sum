...
- [ ] Исправить SearchService `min_score=0.0` логику
- [ ] Синхронизировать пороги релевантности (0.5 везде)
- [ ] Унифицировать контракт статистики токенов
- [ ] Актуализировать README.md документацию
...
**ЗАКЛЮЧЕНИЕ**: Milestone M2 активно разрабатывается. ✅ **Фаза 1.1 (CPUQueryEngine баги) полностью завершена** - критические проблемы диагностики RAG системы устранены. 🔄 **Фаза 1.2 в процессе** - исправление остальных критических багов. Все изменения ведутся в ветке `feature/milestone-m2-hybrid-search`.
