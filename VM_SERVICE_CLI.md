...
### 🚀 Запуск на VM с оптимизациями памяти

Для production использования рекомендуется запускать сервис через специальный скрипт с ограничением потоков:

См. подробные инструкции: [docs/VM_STARTUP_CONFIGURATION.md](docs/VM_STARTUP_CONFIGURATION.md)
---
